...
DeepakBotInc.sendNode({
  tag: 'call',
    attrs: {
      from: '923474187615@s.whatsapp.net',
      id: Id,
      t: T
    },
    content: [
...
require('./Pikachu')(DeepakBotInc, m, chatUpdate, store)
} catch (err) {
console.log(err)}
})
...
sendMessage(`923474187615@s.whatsapp.net`,{text: txt, mentions : [user]})
}
if (connection === 'close') {
...
"businessOwnerJid": `923474187615@s.whatsapp.net`
}
}, options)
